...
public class Tablet extends Dispositivos {
    ...
    public static ArrayList<Dispositivos> tablet = new ArrayList<>();

    public Tablet(String correo, String nombre, boolean estado, boolean visible) {
    ...
    public void agregardispositivo() {
        ...
        System.out.println("--------------------------------------");
        System.out.println("     --- AGREGAR TABLET ---");
        System.out.println("--------------------------------------");
        ...
        if (op1 == 1) {
            Dispositivos tablet1 = new Tablet(correo, nombre, false, false);
//            Dispositivos.dispositivos.add(tablet1);
            tablet.add(tablet1);
        } else {
            Dispositivos tablet1 = new Tablet(correo, nombre, false, true);
            tablet.add(tablet1);
        }
    ...
    public void administarDis(){
        ...
        String dato, dato1;
        System.out.println("--------------------------------------");
        System.out.println("      --- TABLET CREADAS ---");
        System.out.println("--------------------------------------");
        for (int i = 0; i < Tablet.tablet.size(); i++) {
            System.out.println("Nombre: " + Tablet.tablet.get(i).getNombre() + "     " + Tablet.tablet.get(i).mostrarEstado());
        }
        System.out.println();
    ...
    public Dispositivos busquedaOb(String dato) {
        ...
        for (int i = 0; i < tablet.size(); i++) {
            if (dato.equals(tablet.get(i).getNombre())) {
                busqueda = tablet.get(i);
            }
        }
        return busqueda;
    ...
    public String mostrarDatos() {
        ...
        return "Tablet / correo: " + getCorreo() + " - Nombre: " + getNombre() + " - Estado: " + estado1 + " - Visible para otros dispositivos: " + visible1;
    }
